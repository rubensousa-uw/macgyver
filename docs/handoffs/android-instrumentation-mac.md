...
- `InstrumentationTest` contains three targeted tests, including `startThenStopStreaming`, which configures MockDeviceKit media, starts the stream through the UI, captures a photo, and takes the UI teardown route.
